...
In the [GitHub repository of the course](https://github.com/GiorgiaAuroraAdorni/ML-bachelor-course-assignments-sp23), you will find a trained Scikit-learn model that we built using the same dataset you are given. This _baseline_ model can achieve an MSE of **0.844** when evaluated on the test set.
